...
const disposablemedicalpulpcontainers = () => {
  // console.log("hi", data);
    ...
    <>
      ...
      <main id="OurProducts">
        <div className="productLanding" style={{ flexWrap: "wrap" }}>
          {data.map((e, index) => {
            if (
              e.attributes.category_page_l_4.data?.attributes.slug ===
              "disposable-medical-pulp-containers"
            ) {
              return (
                //
...
export default disposablemedicalpulpcontainers;
