      ...
      <main id="ProductPage">
        ...
        <div className="productData">
          <div className="productImg">
            <Image
              src="/assets/images/productdumy.png"
              height={535}
              width={554}
              layout="responsive"
              alt="product3"
          ...
          <div className="productDetails">
            ...
            <p>
              ...
              to amplify and detect pathogen.Vitassay qPCR Kits contains in each
              well enzymes, buffer, primer and probes as well as an internal
              control in a lyophilized format. The kits include a positive and a
              negative control. Identification of pathogen DNA or RNA occurs by
              the use of target specific primers ans fluorecent labeled
              hydrolysis probes which hybridize conserved regions in the genomes
              of the differentpathogens.
            </p>
